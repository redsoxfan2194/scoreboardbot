...
def isD1(team1,team2,m_w):
    ...
    validWTeams = ["Assumption","Bemidji State","Boston College","Boston University","Brown","Clarkson","Colgate","Connecticut", "UConn","Cornell","Dartmouth","Franklin Pierce","Harvard","Holy Cross","Lindenwood", "Long Island University","LIU","Maine","Mercyhurst","Merrimack","Minnesota","Minnesota Duluth","Minnesota State","New Hampshire","Northeastern","Ohio State","Penn State","Post","Princeton","Providence","Quinnipiac","Rensselaer","RIT","Robert Morris","Sacred Heart","St. Anselm","St. Michael's","Saint Anselm","Saint Michael's","St. Cloud State","St. Lawrence", "St. Thomas","Stonehill","Syracuse","Union","Vermont","Wisconsin","Yale"]
